...
?>
        ...
        echo '<a href="partials/_logout.php"><button type="submit" class="btn btn-success mr-2" >
            Logout
        </button></a>';

        echo '<button type="submit" class="btn btn-success mr-2" data-toggle="modal" data-target="#bookingstatus" >
            Booking Status</a>
        </button>';
